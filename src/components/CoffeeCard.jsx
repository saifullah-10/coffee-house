...
export default function CoffeeCard() {
  return (
    <div className="flex items-center justify-between  p-5 bg-[#F5F4F1] rounded-xl">
      <div>
        <img src={Coffee} alt="" />
      </div>
      <div>
        <p>
          <span>Name: </span>Americano Coffee
        </p>
        <p>
          <span>Chef: </span>Mr. Matin Pau
        </p>
        <p>
      ...
      <div className=" flex flex-col gap-3  ">
        <button className="p-2 rounded-xl bg-[#D2B48C]">
          <svg
        ...
        <button className="p-2 rounded-xl bg-[#3C393B]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
